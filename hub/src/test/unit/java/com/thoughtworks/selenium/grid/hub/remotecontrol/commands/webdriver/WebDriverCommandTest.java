...
public class WebDriverCommandTest extends UsingClassMock {
    ...
    public void executeReturnsAnErrorResponseWhenNoSessionIdIsProvided() throws IOException {
        ...
        response = new WebDriverCommand(null, theRequest).execute(null);
